...
DEMOS = [
    ("1_data_parallel/1_ddp_demo.py", "Naive DDP (hand-written gradient All-Reduce averaging)"),
    ("1_data_parallel/2_zero1_demo.py", "ZeRO-1 (optimizer state sharding + All-Gather)"),
    ("1_data_parallel/3_fsdp_demo.py", "ZeRO-3 / FSDP (param + grad sharding, All-Gather + Reduce-Scatter)"),
    ("1_data_parallel/4_hsdp_demo.py", "HSDP (2D mesh: intra-node FSDP + inter-node DDP)"),
    ...
    ("3_pipeline_parallel/6_deepseek_dualpipe.py", "[DeepSeek] DualPipe (bidirectional pipeline overlap)"),
    ...
    ("4_expert_parallel/3_deepseek_moe.py", "[DeepSeek] DeepSeekMoE (fine-grained + shared, aux-loss-free balancing)"),
    ("4_expert_parallel/4_deepseek_deepep.py", "[DeepSeek] DeepEP (overlapped dispatch + combine All-to-All)"),
    ...
    ("6_context_parallel/1_ring_attention.py", "Context Parallel (Ring Attention + online softmax)"),
    ...
    ("8_hybrid_parallel/2_nd_mesh_parallel.py", "N-D (6D) mesh capstone (TP/EP/CP/FS/DP/PP, flash per axis)"),
]
